...
async function classifyProxy(proxy, config) {
  ...
  if (overallSuccess && homeHealth?.success && homeHealth?.positiveSignal?.ok) {
    return {
      level: 'OK',

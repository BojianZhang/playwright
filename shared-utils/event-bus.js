'use strict';
// ⟦共享规范实现 · 改这里;各项目 web/event-bus.js 是 re-export shim,勿改⟧ 边界/准入/清单见 shared-utils/README.md

// ═══════════════════════════════════════════════════════════════════════
// Web 层 — event-bus（规范实现）
//
// 历史出处：Openrouter/0.0.1/web/event-bus.js(现已收口到 shared-utils)
//
// 边界说明（BOUNDARY）：

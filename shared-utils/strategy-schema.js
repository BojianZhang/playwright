'use strict';
// ⟦共享规范实现(控制台配置 schema · OR↔GLM 共享) · 改这里;各项目 web/strategy-schema.js 是 re-export shim,勿改⟧ 见 shared-utils/README.md

// ═══════════════════════════════════════════════════════════════════════
// 环节策略 schema(后端镜像)— 规范实现(历史出处 Openrouter/0.0.1/web/strategy-schema.js)
//

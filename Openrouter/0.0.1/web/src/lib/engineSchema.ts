...
export const ENGINE_FIELDS: Record<EngineKey, EngineField[]> = {
  ...
  selenium: [F_SOLVE, F_HC_RECHECK, F_RESULT_WAIT, F_SAVECARD, F_STALL, F_AUTORETRY, F_AUTORETRY_N, F_NODEL, F_WIZ_PAY, F_WIZ_CREDIT, F_CARD_STRATEGY, F_ZIP_RETRY, F_CARD_FILL],

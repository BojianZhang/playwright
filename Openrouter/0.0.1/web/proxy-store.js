...
// ═══════════════════════════════════════════════════════════════════════
// 代理/IP 池 — Openrouter / web / proxy-store.js
//
...
const FILE = path.join(__dirname, '..', 'data', 'proxies.json');
let _list = null;
let _seq = 0;
...
module.exports = { list, get, add, update, remove, clear, recordTest, setAllType, activeLines, _FILE: FILE };

...
# 用法: python fixb_bind.py <env_id> <卡号> <MMYY> <CVC> <ZIP>
#   例: python fixb_bind.py k1dfjybg 4111111111111111 1229 786 59601
...
def main():
    ...
    try:
        import steps_key; steps_key.dismiss_onboarding(page)
    except Exception:
        pass

...
const TABLE = {
  ...
  GLM_HOME_UNREACHABLE: { action: 'retry-new-proxy', maxRetries: 3 },
...
const CATALOG = {
  ...
  GLM_HOME_UNREACHABLE: { stage: '代理预检', why: '经该代理打不开 OpenRouter 首页（线路被墙/超时）' },
...
let policyStore;
try { policyStore = require('../data/policy-store'); }

...
// ── 进度等级（防重复扣费 + 续跑判定）──────────────────────────────────────
// z.ai 阶梯:registered < apikey < subscribed(订阅=真扣里程碑,绝不降级→防重复扣款)。
// 兼容保留旧模板的 OpenRouter 阶梯键(skipped/address-bound/card-bound/success),互不影响。
const BILLING_LEVEL = { skipped: 0, registered: 1, 'address-bound': 1, apikey: 2, 'card-bound': 2, subscribed: 3, success: 3 };
const REQUESTED_LEVEL = { none: 0, register: 1, apikey: 2, subscribe: 3, address: 1, card: 2, charge: 3 };

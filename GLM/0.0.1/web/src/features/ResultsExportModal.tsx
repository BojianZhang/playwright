...
const SAMPLE: AccountRow = { email: 'user1@firstmail.com', password: 'MyNewPass#2026', originalPassword: 'oldpw123', apiKey: 'xxxxxxxx.xxxxxxxxxxxxxxxx', billingStatus: 'success', charged: 10, cardLast4: '8695', passwordChanged: true, exitIp: '203.0.113.7', nodeId: 'PC-01', createdAt: '2026-06-14 04:14:57' };

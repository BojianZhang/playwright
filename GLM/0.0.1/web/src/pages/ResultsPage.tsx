...
const ACC_COLUMNS: Column<AccountRow>[] = [
  ...
  { key: 'password', label: '现密码', className: 'mono', cellStyle: { color: 'var(--text-2)' }, render: (a) => a.password },
  { key: 'originalPassword', label: '原密码', className: 'mono', cellStyle: { color: 'var(--text-3)' }, defaultHidden: true, render: (a) => a.originalPassword },

...
const FIELDS = [
  ...
  { key: 'fastMode', env: 'GLM_FAST', type: 'select', scope: 'both', group: '提速', def: '', options: ['', 'on'] },
  ...
  { key: 'maxConcurrency', env: 'GLM_MAX_CONCURRENCY', type: 'number', scope: 'both', group: '驱动环境', def: '' },

...
const PATHS = {
  batchResults: path.join(RUNNER_DIR, 'batch-results'),
  accountsDone: path.join(RUNNER_DIR, 'batch-results', 'accounts-done.txt'),
  batchLatest: path.join(RUNNER_DIR, 'batch-results', 'latest'),
  batchSummaryLatest: path.join(RUNNER_DIR, 'batch-results', 'latest', 'dreamina-batch-summary-latest.json'),
  cliResults: path.join(RUNNER_DIR, 'results'),
  sessionRecords: path.join(RUNNER_DIR, 'session-records'),
  registered: path.join(ACCOUNT_STATE_DIR, 'registered-accounts.json'),
  local: path.join(ACCOUNT_STATE_DIR, 'local-accounts.json'),
  failureEvents: path.join(RUNNER_DIR, 'batch-results', 'failure-events.jsonl'),
};

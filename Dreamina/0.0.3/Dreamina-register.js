...
const { updateWorkerStatus } = require('../../shared-utils/worker-status-tracker');
...
const { runProxyPrecheckChain } = require('../../shared-proxy-precheck/proxy-precheck');
// 阶段 1：entry 公共骨架。
const { runEntryStage } = require('../../shared-entry/entry');

// 阶段 2：credential submit 公共骨架。
const { runCredentialSubmitStage } = require('../../shared-credential/credential-submit');
// 阶段 3：verification submit 公共骨架。
const { runVerificationSubmitStage } = require('../../shared-verification/verification-submit');
// 阶段 4：profile completion submit 公共骨架。
const { runProfileCompletionSubmitStage } = require('../../shared-profile-completion/profile-completion-submit');
// 阶段 5：post-auth-ready 公共骨架。
const { runPostAuthReadyStage } = require('../../shared-post-auth-ready/post-auth-ready');
// 阶段 6：account-delivery 公共骨架。
const { runAccountDeliveryStage } = require('../../shared-account-delivery/account-delivery');
...
const dreaminaProxyPrecheckAdapter = require('./S0-proxy-precheck/proxy-precheck-adapter');
...
const dreaminaCredentialAdapter = require('./S2-credential/credential-adapter');
// 阶段 3：Dreamina verification adapter。
const dreaminaVerificationAdapter = require('./S3-verification/verification-adapter');
// 阶段 4：Dreamina profile completion adapter。
const dreaminaProfileCompletionAdapter = require('./S4-profile-completion/profile-completion-adapter');
// 阶段 5：Dreamina post-auth-ready adapter。
const dreaminaPostAuthReadyAdapter = require('./S5-post-auth-ready/post-auth-ready-adapter');
// 阶段 6：Dreamina account-delivery adapter。
const dreaminaAccountDeliveryAdapter = require('./S6-account-delivery/account-delivery-adapter');
...
function appendBadProxyRecord(proxy = null, reason = '') {
  ...
  const filePath = path.join(__dirname, 'S0-proxy-precheck', 'data', 'bad-proxies.txt');

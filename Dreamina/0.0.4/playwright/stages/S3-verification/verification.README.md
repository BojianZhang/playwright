...
**文件位置**：`Dreamina/0.0.3/S3-verification/`
**阶段标识**：`S3`
**阶段名称**：验证码提交（Verification Submit）

对应文件：
- `verification-adapter.js`
- `verification-adapter.PARAMS.md`（入参与方法签名说明）
- `verification-adapter.FIELDS.md`（返回字段说明）
- `profiles/dreamina-verification-profile.json`（程序读取）

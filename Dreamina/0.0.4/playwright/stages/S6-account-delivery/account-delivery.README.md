...
**文件位置**：`Dreamina/0.0.3/S6-account-delivery/`
**阶段标识**：`S6`
**阶段名称**：账号交付（Account Delivery）

对应文件：
- `Dreamina/0.0.3/S6-account-delivery/account-delivery-adapter.js`
- `account-delivery-adapter.PARAMS.md`（入参与方法签名说明）
- `account-delivery-adapter.FIELDS.md`（返回字段说明）
- `profiles/dreamina-account-delivery-profile.json`（程序读取）

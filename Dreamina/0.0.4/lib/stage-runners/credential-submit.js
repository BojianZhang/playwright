// ═══════════════════════════════════════════════════════════════════════
// 框架层（FRAMEWORK LAYER）— S2 credential
//
// 文件定位：shared-credential/credential-submit.js
//
// 边界说明（BOUNDARY）：
// ✅ 负责 —— 凭据提交阶段调度器。
...
// 依赖方：Dreamina/0.0.3/Sn-xxx/ 下对应的 adapter（调用 credential-adapter（当前绑定 Dreamina），完成邮箱/密码填写并返回 CredentialResult）
// ═══════════════════════════════════════════════════════════════════════
'use strict';

'use strict';
// ⟦共享规范实现(工厂) · 改这里;各项目 web/setup-store.js 是注入 dataDir 的 re-export shim,勿改⟧ 见 shared-console-stores/README.md
...
module.exports = function createSetupStore({ dataDir }) {
const STATE_FILE = path.join(dataDir, 'setup-state.json');
...
return { getState, setCompleted, setDismissed, reset, _STATE_FILE: STATE_FILE };
};

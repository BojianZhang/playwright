'use strict';
// ⟦共享规范实现(工厂) · 改这里;各项目 web/usage-store.js 是注入 dataDir 的 re-export shim,勿改⟧ 见 shared-console-stores/README.md
...
module.exports = function createUsageStore({ dataDir }) {
...
return { record, recordMany, list, byEmail, byCard, byProxy, byEnv, clear, _FILE: FILE };
};

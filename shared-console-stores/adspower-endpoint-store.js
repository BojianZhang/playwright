'use strict';
// ⟦共享规范实现(工厂) · 改这里;各项目 web/adspower-endpoint-store.js 是注入 dataDir 的 re-export shim,勿改⟧ 见 shared-console-stores/README.md
...
module.exports = function createAdspowerEndpointStore({ dataDir }) {
const FILE = path.join(dataDir, 'adspower-endpoints.json');
let _list = null;
let _seq = 0;
...
return { list, getFull, activeFull, add, update, remove, clear, recordTest, _FILE: FILE };
};

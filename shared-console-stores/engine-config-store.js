'use strict';
// ⟦共享规范实现(工厂) · 改这里;各项目 web/engine-config-store.js 是注入 dataDir+engineSchema 的 shim,勿改⟧ 见 shared-console-stores/README.md
...
module.exports = function createEngineConfigStore({ dataDir, engineSchema }) {
const { ENGINES, DEFAULTS, KEYS } = engineSchema;

const FILE = path.join(dataDir, 'engine-configs.json');
const NAME_MAX = 40;
...
return { getAll, activeOpts, savePreset, deletePreset, setActive, _FILE: FILE };
};

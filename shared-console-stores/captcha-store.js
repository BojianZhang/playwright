'use strict';
// ⟦共享规范实现(工厂) · 改这里;各项目 web/captcha-store.js 是注入 dataDir 的 re-export shim,勿改⟧ 见 shared-console-stores/README.md
...
module.exports = function createCaptchaStore({ dataDir }) {
const FILE = path.join(dataDir, 'captcha-keys.json');
let _list = null;
let _seq = 0;
...
return { list, getFull, pickActive, add, importRaw, update, remove, clear, recordBalance, _FILE: FILE };
};

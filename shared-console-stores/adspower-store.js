'use strict';
// ⟦共享规范实现(工厂) · 改这里;各项目 web/adspower-store.js 是注入 dataDir 的 re-export shim,勿改⟧ 见 shared-console-stores/README.md
...
module.exports = function createAdspowerStore({ dataDir }) {
const FILE = path.join(dataDir, 'adspower.json');
let _list = null;
...
return { list, add, update, remove, clear, activeRaw, _FILE: FILE };
};

'use strict';
// ⟦共享规范实现(工厂) · 改这里;各项目 web/advanced-store.js 是注入 dataDir+schema 的 shim,勿改⟧ 见 shared-console-stores/README.md
...
module.exports = function createAdvancedStore({ dataDir, schema }) {
const FILE = path.join(dataDir, 'advanced-params.json');
let _db = null;

function _load() {
  if (_db) return _db;
  const o = readJsonOr(FILE, {}, 'advanced-store'); _db = (o && typeof o === 'object' && !Array.isArray(o)) ? o : {};   // ★H4:解析失败先备份 .corrupt
  return _db;
}
function _persist() {
  try {

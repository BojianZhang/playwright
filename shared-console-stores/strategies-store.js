'use strict';
// ⟦共享规范实现(工厂) · 改这里;各项目 web/strategies-store.js 是注入 dataDir 的 re-export shim,勿改⟧ 见 shared-console-stores/README.md
...
const { STAGES, DEFAULTS, KEYS } = require('../shared-utils/strategy-schema');

module.exports = function createStrategiesStore({ dataDir }) {
const FILE = path.join(dataDir, 'strategies.json');
const NAME_MAX = 40;
